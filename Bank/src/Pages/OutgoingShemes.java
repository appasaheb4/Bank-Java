...
public class OutgoingShemes extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OutgoingShemes frame = new OutgoingShemes();
	...
	public OutgoingShemes() {
		...
		JLabel lblIncomeLoan = new JLabel("Outgoing Shemes");
		...
		button.setIcon(new ImageIcon(OutgoingShemes.class.getResource("/ImageButtonIcon/clac.png")));
		...
		button_1.setIcon(new ImageIcon(OutgoingShemes.class.getResource("/ImageButtonIcon/Exit.png")));
		...
		button_1.setBounds(30, 559, 115, 38);
	...
	public void showdata() {
		try {
			...
			while (rs.next()) {
				...
				double data3 = rs.getDouble("SchPer");
