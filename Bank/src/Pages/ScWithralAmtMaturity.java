...
public class ScWithralAmtMaturity extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ScWithralAmtMaturity dialog = new ScWithralAmtMaturity();
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							conn = DBConnection.getConnection();
							String updatedata = "update banksystem.schemea_c set Date='" + (java.sql.Date) d
									+ "',Amount='" + 0 + "',SchPer='" + 0 + "',SchAmt='" + 0 + "',Total='" + 0
									+ "' where AccountNo='" + SchemeA_C.acno + "'";
