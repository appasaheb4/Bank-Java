...
public class TranEmployees extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TranEmployees frame = new TranEmployees();
	...
	public TranEmployees() {
		...
		button.setIcon(new ImageIcon(TranEmployees.class.getResource("/ImageButtonIcon/Exit.png")));
		...
		button_1.setIcon(new ImageIcon(TranEmployees.class.getResource("/ImageButtonIcon/Report4d.png")));
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					para.put("Acno", ReportEmployess.name);
	...
	public void loandatashow() {
		...
		try {
			...
			String quey = "SELECT * FROM banksystem.emptrancation where AccountNo='" + ReportEmployess.name + "';";
