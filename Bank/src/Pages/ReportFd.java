...
public class ReportFd extends JFrame {
	...
	public ReportFd() {
		...
		JLabel lblNewLabel = new JLabel("Fd Report");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					while (rs.next()) {
						...
						String data8 = String.valueOf(df.format(aii));
		...
		scrollPane.setBounds(10, 11, 1114, 399);
		panel_1.add(scrollPane);

		tableFDA_C = new JTable();
		...
		tableFDA_C.setModel(new DefaultTableModel(
			...
			new String[] {
				"Select", "SrNoMaster", "SrNo", "Date", "Update Date", "A/C No", "Name ", "Int  %", "Balance", "Interes Amt", "Duration", "Days", "Matirutiy Amt", "Loan Per", "Loan Amount", "Interst", "Interst Amt", "Total L Amt", "Nomeny", "Nomeny Relation", "Address", "Age", "Contact No", "Nots"
			}
		) {
		...
		tableFDA_C.getColumnModel().getColumn(9).setPreferredWidth(15);
		tableFDA_C.getColumnModel().getColumn(9).setMinWidth(0);
		tableFDA_C.getColumnModel().getColumn(9).setMaxWidth(0);
		tableFDA_C.getColumnModel().getColumn(10).setPreferredWidth(80);
		tableFDA_C.getColumnModel().getColumn(10).setMinWidth(80);
		tableFDA_C.getColumnModel().getColumn(11).setPreferredWidth(50);
		tableFDA_C.getColumnModel().getColumn(11).setMinWidth(0);
		tableFDA_C.getColumnModel().getColumn(11).setMaxWidth(0);
		tableFDA_C.getColumnModel().getColumn(12).setPreferredWidth(80);
		...
		tableFDA_C.getColumnModel().getColumn(16).setPreferredWidth(15);
		tableFDA_C.getColumnModel().getColumn(16).setMinWidth(0);
		tableFDA_C.getColumnModel().getColumn(16).setMaxWidth(0);
					...
					for (int i = 0; i <= tableFDA_C.getRowCount(); i++) {
						...
						if (che) {
							if (checkBoxseall.isSelected()) {
								java.io.InputStream file = getClass().getResourceAsStream("/Reports/Fdall.jrxml");

								allinonereport r = new allinonereport("Fd Report", file);
		...
		button_1.setIcon(new ImageIcon(ReportFd.class.getResource("/ImageButtonIcon/Report4d.png")));
		...
		btnExit.setIcon(new ImageIcon(ReportFd.class.getResource("/ImageButtonIcon/Exit.png")));
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					for (int i = 0; i < tableFDA_C.getRowCount(); i++) {
						Boolean isChecked = Boolean.valueOf(tableFDA_C.getValueAt(i, 0).toString());
						if (checkBoxseall.isSelected()) {
							tableFDA_C.setValueAt((Object) s1, i, 0);
						} else {
							tableFDA_C.setValueAt((Object) s, i, 0);
						}
					}
