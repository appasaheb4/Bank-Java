...
public class FDMatureIncrementDate extends JDialog {
	...
	public static void main(String[] args) {
		try {
			FDMatureIncrementDate dialog = new FDMatureIncrementDate();
	 ...
	 * Create the dialog.
	 */
	public FDMatureIncrementDate() {
		addWindowListener(new WindowAdapter() {
			@Override
			public void windowOpened(WindowEvent e) {
				try {
					String acno = FDA_C.acno;
					...
					String query = "Select * from banksystem.fd where AccountNumber='" + acno + "';";
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							...
							double amount = Double.valueOf(textFieldMaturityAmt.getText());
							double interst = Double.valueOf(textFieldInterst.getText());
							double incount = amount * interst / 100;
							double sumamt = amount + incount;

							conn = (Connection) DBConnection.getConnection();
							String up = "UPDATE banksystem.fd set Date=?,UpdateDate=?, Amount=?, Interes=?, IntsetAmt=?, Total=?, Duration=?, Days=? where AccountNumber='"
									+ FDA_C.acno + "'";
							...
							ps.setDouble(3, Double.valueOf(textFieldMaturityAmt.getText()));
							ps.setDouble(4, Double.valueOf(textFieldInterst.getText()));
							ps.setDouble(5, incount);
							ps.setDouble(6, sumamt);
