...
public class SchPremature extends JDialog {
	...
	public static void main(String[] args) {
		try {
			SchPremature dialog = new SchPremature();
	...
	public SchPremature() {
		...
		{
			JLabel lblNewLabel = new JLabel("Your Scheme is premature ,");
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						dispose();
				SchWithralAmt sw=new SchWithralAmt();
				sw.setVisible(true);
