...
public class RecPremature extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RecPremature dialog = new RecPremature();
	...
	public RecPremature() {
		...
		{
			JLabel lblNewLabel = new JLabel("Your recrring is premature ,");
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						dispose();
					RecuringWithralAmt sss=new RecuringWithralAmt();
					sss.setVisible(true);
