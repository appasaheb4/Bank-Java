...
public class OutgoingRecurring extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OutgoingRecurring frame = new OutgoingRecurring();
	...
	public OutgoingRecurring() {
		...
		JLabel lblIncomeLoan = new JLabel("Outgoing Recurring");
		...
		dateChooser.setBounds(856, 45, 196, 20);
		dateChooser.setDate(date77);
		...
		button.setIcon(new ImageIcon(OutgoingRecurring.class.getResource("/ImageButtonIcon/clac.png")));
		...
		tableIncomeLoan.setModel(new DefaultTableModel(new Object[][] {},
				new String[] { "Select", "SrNo", "Date", "Name", "Loan Int", "Amount" }) {
		...
		button_1.setIcon(new ImageIcon(OutgoingRecurring.class.getResource("/ImageButtonIcon/Exit.png")));
		...
		button_1.setBounds(10, 570, 115, 38);
	...
	public void showdata() {
		try {
			...
			while (rs.next()) {
				...
				double data3 = rs.getDouble("Intrest");
