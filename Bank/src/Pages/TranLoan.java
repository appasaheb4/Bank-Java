...
public class TranLoan extends JFrame {
	...
	public TranLoan() {
		...
		button.setIcon(new ImageIcon(TranLoan.class.getResource("/ImageButtonIcon/Exit.png")));
		...
		button_1.setIcon(new ImageIcon(TranLoan.class.getResource("/ImageButtonIcon/Report4d.png")));
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					
					java.io.InputStream file=getClass().getResourceAsStream("/Reports/TranLoan.jrxml");
							String accno4 = ReportLoan.accno;
	...
	public void loandatashow() {
		...
		try {
			...
			String show = "select * from banksystem.loantranscation where AccountNo='" + ReportLoan.accno + "'";
